...
!function(){"use strict";var t=document.querySelector(".post-content"),v=document.querySelector(".time-bar"),y=!0;if(t&&v){var g=0,E=t.scrollHeight,h=v.querySelector(".completed"),S=v.querySelector(".remaining"),f=v.querySelector(".time-completed"),I=v.querySelector(".time-remaining");document.addEventListener("scroll",function(){var t,e,n=window.pageYOffset||document.documentElement.scrollTop;if(v.style.bottom=g<n&&y?"auto":"auto%",n<=E){var r=n/E,i=(100*r).toFixed(2),o=100-parseFloat(i);h.style.width=i.toString()+"%",S.style.width=o.toString()+"%";var a=60*parseInt(v.getAttribute("data-minutes")),s=parseInt(r*a),c=parseInt(s/60),u=parseInt(60*(s/60-c)),d=a-s,l=parseInt(d/60),m=parseInt(60*(d/60-l));c=c<10?"0"+c:c,u=u<10?"0"+u:u,l=l<10?"0"+l:l,m=m<10?"0"+m:m,f.innerText=c+":"+u,I.innerText=l+":"+m,y=!0,(e=document.createEvent("CustomEvent")).initCustomEvent("stillReading"),document.dispatchEvent(e)}else{h.style.width="100%",S.style.width="0%";var p=parseInt(v.getAttribute("data-minutes"));p=p<10?"0"+p:p,f.innerText="00:00",I.innerText=p+":00",y=!1,(t=document.createEvent("CustomEvent")).initCustomEvent("finishedReading"),document.dispatchEvent(t)}g=n})}}();
