...
!function(){"use strict";var e=document.querySelector(".post-content"),v=document.querySelector(".time-bar");if(e&&v){var y=e.scrollHeight,g=v.querySelector(".completed"),E=v.querySelector(".remaining"),h=v.querySelector(".time-completed"),S=v.querySelector(".time-remaining");document.addEventListener("scroll",function(){var e,t,n=window.pageYOffset||document.documentElement.scrollTop;if(v.style.bottom="0%",n<=y){var r=n/y,i=(100*r).toFixed(2),o=100-parseFloat(i);g.style.width=i.toString()+"%",E.style.width=o.toString()+"%";var s=60*parseInt(v.getAttribute("data-minutes")),a=parseInt(r*s),c=parseInt(a/60),d=parseInt(60*(a/60-c)),u=s-a,l=parseInt(u/60),m=parseInt(60*(u/60-l));c=c<10?"0"+c:c,d=d<10?"0"+d:d,l=l<10?"0"+l:l,m=m<10?"0"+m:m,h.innerText=c+":"+d,S.innerText=l+":"+m,!0,(t=document.createEvent("CustomEvent")).initCustomEvent("stillReading"),document.dispatchEvent(t)}else{g.style.width="100%",E.style.width="0%";var p=parseInt(v.getAttribute("data-minutes"));p=p<10?"0"+p:p,h.innerText="00:00",S.innerText=p+":00",!1,(e=document.createEvent("CustomEvent")).initCustomEvent("finishedReading"),document.dispatchEvent(e)}n})}}();
